...
- ordinary UTF-8 output is readable directly in the event file, binary output survives without lossy conversion, and the output cap cannot leave the shell blocked on an undrained pipe;
